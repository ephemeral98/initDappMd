import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.9dd9ad44.js";const B=JSON.parse('{"title":"横向选项卡源码：","description":"","frontmatter":{},"headers":[],"relativePath":"FrontEnd/BPComponents/BpTab/source.md","filePath":"FrontEnd/BPComponents/BpTab/source.md","lastUpdated":1693989405000}'),p={name:"FrontEnd/BPComponents/BpTab/source.md"},o=l(`<h1 id="横向选项卡源码" tabindex="-1">横向选项卡源码： <a class="header-anchor" href="#横向选项卡源码" aria-label="Permalink to &quot;横向选项卡源码：&quot;">​</a></h1><div class="language-ts vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">ts</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">// type.d.ts</span></span>
