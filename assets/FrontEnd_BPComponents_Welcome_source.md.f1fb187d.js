import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.9dd9ad44.js";const u=JSON.parse('{"title":"开屏动画组件源码：","description":"","frontmatter":{},"headers":[],"relativePath":"FrontEnd/BPComponents/Welcome/source.md","filePath":"FrontEnd/BPComponents/Welcome/source.md","lastUpdated":1693989405000}'),p={name:"FrontEnd/BPComponents/Welcome/source.md"},o=l(`<h1 id="开屏动画组件源码" tabindex="-1">开屏动画组件源码： <a class="header-anchor" href="#开屏动画组件源码" aria-label="Permalink to &quot;开屏动画组件源码：&quot;">​</a></h1><div class="language-vue vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">vue</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#6A737D;">&lt;!-- 欢迎页 --&gt;</span></span>
