import{_ as s,o as n,c as a,Q as l}from"./chunks/framework.9dd9ad44.js";const u=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"BackEnd/allowAccount/source.md","filePath":"BackEnd/allowAccount/source.md","lastUpdated":1693989405000}'),p={name:"BackEnd/allowAccount/source.md"},o=l(`<h2 id="身份校验源码-go" tabindex="-1">身份校验源码(Go) <a class="header-anchor" href="#身份校验源码-go" aria-label="Permalink to &quot;身份校验源码(Go)&quot;">​</a></h2><div class="language-go vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">go</span><pre class="shiki github-dark vp-code-dark"><code><span class="line"><span style="color:#F97583;">package</span><span style="color:#E1E4E8;"> </span><span style="color:#B392F0;">middleware</span></span>
